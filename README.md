...
<div class="container">
    ...
    <div class="menu-grid">
        ...
        <div class="menu-item">
            <img src="pizza.webp" alt="Food 1"style="width:20%; height:100px;">
            <h3>Pizza</h3>
            <p>120</p>
        </div>
        <div class="menu-item">
        ...
        <div class="menu-item">
            <img src="icecream.webp" alt="Food 3"style="width:20%; height:100px;">
            <h3>Icecream</h3>
            <p>110</p>
        </div>
        <div class="menu-item">
            <img src="tiramisu.webp" alt="Food 3"style="width:20%; height:100px;">
            <h3>Tiramisu</h3>
            <p>90</p>
        </div>
...
<head>
    <meta charset="UTF-8">
    <title>Administration - Delicious Bites</title>
    <link rel="stylesheet" href="css/style.css">
</head>
<body>
...
<div class="container">
    ...
    <div class="admin-grid">
        ...
        <div class="admin-item">
            <img src="person 3.jpg" alt="Person 3"style="width:20%; height:100px;">
            <h3>Sid</h3>
            <p>Waiter</p>
        </div>
        <div class="admin-item">
            <img src="person 4.jpg" alt="Person 4"style="width:20%; height:100px;">
            <h3>Surya</h3>
            <p>Chef</p>
        </div>
...
<div class="container">
    ...
    <img src="food.jpg" alt="Restaurant Image" style="width:25%; height:50%; margin-top:40px;">
    <img src="food2.jpg" alt="Restaurant Image" style="width:30%; height:50%; margin-top:40px;">
    <img src="food3.jpg" alt="Restaurant Image" style="width:28%; height:50%; margin-top:40px;">
</div>
...
![alt text](<Screenshot 2025-10-03 135621.png>)
![alt text](<Screenshot 2025-10-03 132838.png>)
